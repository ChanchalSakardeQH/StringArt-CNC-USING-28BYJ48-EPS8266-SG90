...
//  Adafruit_SSD1306 + Adafruit_GFX, so the sketch still needs nothing beyond
//  the ESP8266 core. About 250 lines: an init sequence, a 1 KB framebuffer, a
...
struct Dash {
  const char *status;   // RUN, WRAP, MOVE, READY ...
